    ...
    >
      ...
      {isMaterial && (
        <a
          ...
          className={styles.link_materials}
        >
      ...
      {isTextureImage && isFullMode && (
        <button
          id={"textureDownloadApp"}
          className={classNames(styles.button, styles.buttonDonwloadTexture)}
        ...
        >
          ...
          >
            <path
              d="M104.6 63.6H79.1V22.1C79.1 20.6 77.9 19.4 76.4 19.4H64.9C63.4 19.4 62.2 20.6 62.2 22.1V63.6H36.7C34.2 63.6 33 66.6 34.8 68.3L68.8 100.3C69.9 101.3 71.5 101.3 72.5 100.3L106.5 68.3C108.3 66.6 107.1 63.6 104.6 63.6Z"
              fill="black"
            />
            <path
              d="M13.1 100.6V107C13.1 115.5 20 122.4 28.5 122.4H113.3C121.8 122.4 128.7 115.5 128.7 107V100.6"
              stroke="black"
              strokeWidth="8.5039"
              strokeMiterlimit="10"
              strokeLinecap="round"
