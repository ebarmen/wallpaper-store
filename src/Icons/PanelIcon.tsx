  ...
  return (
    <div className={styles.panelIconWrap}>
      <svg
        ...
        x="0px"
        y="0px"
        viewBox="0 0 122.5 204.2"
        xmlSpace="preserve"
      >
        <path
          d="M57.4,0H14.9C7,0,0.6,6.4,0.6,14.3v176.5c0,7.9,6.4,14.3,14.3,14.3h92.8c7.9,0,14.3-6.4,14.3-14.3V64L57.4,0z M59.9,14.5
                ...
                c0,7.9,6.4,14.3,14.3,14.3h47.8v120.7C113.4,193.9,110.9,196.5,107.7,196.5z"
          fill=""
        />
      </svg>
    </div>
