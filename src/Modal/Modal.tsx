...
function ModalWindow({text, isVisible, onClose}:{text:string, isVisible: boolean, onClose: any}) {
  ...
  useEffect(() => {
    ...
    <div ref={ref} className={styles.form}>
      ...
      <div className={classNames(styles.input_container, styles.ic1)}>
        ...
        <label htmlFor="firstname" className={styles.placeholder}>Имя</label>
      </div>
      <div className={classNames(styles.input_container, styles.ic2)}>
        <input id="lastname" className={styles.input} type="text" placeholder=" " />
        <div className={styles.cut}></div>
        <label htmlFor="lastname" className={styles.placeholder}>Телефон</label>
      </div>
      <div className={classNames(styles.input_container, styles.ic2)}>
      ...
      <button type="submit" className={styles.submit}>Написать</button>
      <button className={styles.closeButton} onClick={() => onClose()}><svg width={'30px'} height={'30px'} version="1.1"
