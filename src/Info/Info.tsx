      ...
      <div className={styles.container}>
        <div className={styles.left}>
          <div className={styles.info_block}>
            ...
            <div className={styles.description}>
              Стандартные панели - <br /> Бесшовное полотно - <br /> Кастомные
              размер по спецзаказу.
            </div>
          </div>
          <div className={styles.info_block}>
          ...
          <div className={styles.info_block}>
            ...
            <div className={styles.description}>
              Клей для флизелиновых обоев <br />
              <a
                href={`/info/wall/instruktsiya-po-pokleyke/`}
                target="_blank"
        ...
        <div className={styles.center}>
          <div className={styles.info_block}>
            ...
            <div className={styles.description}>
              - сокращение сроков <br /> - любой цвет основы и рисунка <br /> -
              купить краску для соседних стен <br /> - сделать объемным рисунок{" "}
              <br /> - изменить композицию под ваш интерьер <br /> - добавление
              золота, серебра, перламутра, и т.д. в ваш рисунок <br /> -
              бесшовное или на рулонах изменение масштаба
            </div>
          </div>
          <div className={styles.info_block}>
