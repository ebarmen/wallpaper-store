...
function ThumbsList({images,onThumbClick,imageByIndex,selectedIndex}:{images:string[],onThumbClick: (index:number)=> void, imageByIndex: (index:number)=> string,selectedIndex: number}) {
