...
const EmblaCarousel: React.FC<PropType> = (props) => {
  ...
  const [isvisibFullscreenImage, setIsvisibFullscreenImage] =
  ...
  useEffect(() => {
    ...
    let srcData =
      CartData && CartData.map((i: any) => "https://dev.fresq.ru/" + i);
  ...
  return (
    <>
      <div className="header_cart_container">
        ...
        <div className="embla">
          <div className="embla__viewport" ref={emblaRef}>
            ...
            <button
              className="fullscreenButtonGallery"
              onClick={() => setIsvisibFullscreenImage(true)}
            >
              <svg
                version="1.1"
              ...
              >
                <g>
                  <path
                    d="M59.1,0.1H8.9C4,0.1,0.1,4,0.1,8.9v50.2c0,3.9,3.2,7.1,7.1,7.1s7.1-3.2,7.1-7.1V24.3L47,57.1c1.4,1.4,3.2,2.1,5,2.1
       s3.6-0.7,5-2.1c2.8-2.8,2.8-7.3,0-10L24.3,14.3h34.8c3.9,0,7.1-3.2,7.1-7.1S63,0.1,59.1,0.1z"
                  />
                  <path
                    d="M149.3,90.4c-3.9,0-7.1,3.2-7.1,7.1v34.8l-32.8-32.8c-2.8-2.8-7.3-2.8-10,0s-2.8,7.3,0,10l32.8,32.8H97.4
       c-3.9,0-7.1,3.2-7.1,7.1s3.2,7.1,7.1,7.1h50.2c4.8,0,8.8-3.9,8.8-8.8V97.4C156.4,93.5,153.2,90.4,149.3,90.4z"
        ...
        <div className="present_container">
          <div className="present_title">
            <div className="present_title-name">
              Обои ручной работы <br />{" "}
              <span className="cart-name">
                {cartInfoData && cartInfoData.name}{" "}
              </span>
            </div>
            <div className="begin_price">
              от {cartInfoData && cartInfoData.price} р./м2
            </div>
          </div>
          <div className="present_description">
            Графические линейные коллекции обоев выполнены метализированными
            чернилами.Графические линейные коллекции обоев выполнены
            метализированными чернилами.Графические линейные коллекции обоев
            выполнены метализированными чернилами
          </div>
          <div className="present_buttons">
            <button
              className="header_buttons hb1"
            ...
            <button className="header_buttons hb2" onClick={goToAnchor}>
              Рассчитать стоимость обоев
            </button>
            <button
              className="header_buttons hb3"
              onClick={() => setIsVisible(true)}
            >
      ...
      {isvisibFullscreenImage && (
        <FullScreenImage
          img={imageByIndex(selectedIndex)}
